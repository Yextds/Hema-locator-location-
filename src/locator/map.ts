...
export function addMarkersToMap(locations) {
  ...
  marker_icon = "/images/location-pin.png";
  selected_marker_icon =  "/images/location-pin-selected.png";
...
export function highlightLocation(
  ...
  if(infoWindow){   
      ...
      markerContent += '<div class="addressData pl-4 w-1/2">'+address+'</div>';
      markerContent += '<div class="phone text-sm pl-2 mb-2 mt-2">' +phone+ "</div>";
  ...
  let markerLabel = Number(selectedLocationIndex + 1) ;
    ...
    if(infoWindow){   
      ...
      markerContent += '<div class="nameData font-bold text-sm md:text-base">'+storelocationName+'</div>';
      markerContent += '<div class="addressData w-1/2 pl-4">'+address+'</div>';
      markerContent += '<div class="phone text-sm pl-2 mb-2 mt-2">' +phone+ "</div>";
      if
        (openCloseTime)
        {
      markerContent += '<div class="openCloseTimeData mt-2 md:mt-3 capitalize">'+openCloseTime+'</div>'+'<br>';
        }
